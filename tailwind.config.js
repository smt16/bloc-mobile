  ...
  theme: {
    extend: {
      ...
      fontSize: {
        ...
        display: [
          '48px',
          { lineHeight: '48px', letterSpacing: '1.5px', fontWeight: '400' },
        ],
        h1: ['32px', { lineHeight: '34px', letterSpacing: '1px', fontWeight: '400' }],
        h2: ['24px', { lineHeight: '26px', letterSpacing: '0.8px', fontWeight: '400' }],
        body: ['16px', { lineHeight: '22px', fontWeight: '400' }],
        'body-strong': ['16px', { lineHeight: '22px', fontWeight: '700' }],
        caption: ['12px', { lineHeight: '16px', letterSpacing: '0.4px', fontWeight: '400' }],
        overline: [
          '10px',
          { lineHeight: '14px', letterSpacing: '1.8px', fontWeight: '700' },
        ],
      },
    },
  },
